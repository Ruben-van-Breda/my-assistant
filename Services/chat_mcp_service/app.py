...
@app.route('/')
def home():
    return jsonify({"message": "Chat GPT with MCP Server Service is running!"})
...
@app.route('/help')
def help_page():
    return "This is Chat GPT with MCP Serve, providing various endpoints for data processing and querying."
