...
def Query(prompt, model="gpt-4"):
    try:
        system_prompt = "Siperb is a Softphone Company. Your name is Bobby\n Introduce your self at the start of the conversation.\n You are a helpful assistant."
...
@app.route('/')
def home():
    return jsonify({"message": "Siperb Knowledge Base Service is running!"})
...
@app.route('/help')
def help_page():
    return "This is Siperb Knowledge Base Service, providing various endpoints for data processing and querying."
